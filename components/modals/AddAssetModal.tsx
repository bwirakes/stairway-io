      ...
      <DialogContent className="sm:max-w-3xl">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-4 space-y-6">
          ...
          <div>
            ...
            <select
              {...register('assetCategory', { required: 'Asset Category is required' })}
              className={cn(
                'mt-1 block w-full border rounded-md shadow-sm',
                errors.assetCategory ? 'border-red-500' : 'border-gray-300'
              )}
            >
          ...
          <div>
            ...
            <input
              ...
              className={cn(
                'mt-1 block w-full border rounded-md shadow-sm',
                errors.assetValue ? 'border-red-500' : 'border-gray-300'
              )}
            />
            {errors.assetValue && (
              <p className="mt-1 text-sm text-red-600">{errors.assetValue?.message?.toString()}</p>
            )}
          </div>
